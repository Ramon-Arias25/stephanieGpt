...
from Stephanie.configurer import config #Comentado
...
class Boot:
    ...
    def initiate(self):
        print("Stephanie is on and charging, wait for the beep to give your command.")
        ...
        if self.c.config.getboolean("SYSTEM", "wake_up_engine"):
            ...
            self.speaker.speak("How I can help?")
            while self.status:
                with sr.Microphone() as source:
                    assistant.main(source)
                    if self.events.active_status:
